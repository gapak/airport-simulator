...
export class Gin {
    ...
    loadGame = (save_name = 0) => {
        ...
        this.setState(_.assign(this.stateGenerator(), _.pickBy(app_state, v => !_.isNaN(v) && v !== undefined)));
    };

    loadDefaultGame = () => {
        var app_state = this.getCurrentSaveJSON();
        this.setState(app_state ? _.assign(this.stateGenerator(), _.pickBy(app_state, v => !_.isNaN(v) && v !== undefined)) : _.assign(this.store, this.stateGenerator()));
    };
    ...
    setStore = next_store => {
        //console.log("set store " + this.store.tick);
        //console.log(next_store);
        this.store = _.assign(this.store, _.pickBy(next_store, v => !_.isNaN(v) && v !== undefined));
    };
